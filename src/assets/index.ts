const Icon = {
  ...
  learn: require('./icons/future.png'),
  stock: require('./icons/stocks.png'),
  deposit: require('./icons/deposits.png'),
  earn: require('./icons/earn.png'),
